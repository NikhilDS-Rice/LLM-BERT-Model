...
class BidirectionalLSTMModel(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim, num_layers):
        ...
        self.lstm = nn.LSTM(
            embedding_dim, hidden_dim, num_layers, batch_first=True, dropout=0.2, bidirectional=True
        )
...
# TensorBoard writer
writer = SummaryWriter(log_dir="runs/Bi-LSTM_lr_0.0001")
...
torch.save(trained_model.state_dict(), "Bi-LSTM_comment_model.pth")
